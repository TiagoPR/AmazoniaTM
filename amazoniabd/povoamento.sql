...
Insert into Funcionario (Funcionario_ID, Nome, Tipo,Salario,Endereco,Desempenho,fk_Armazem_Armazem_ID,data_nascimento,data_comeco,genero)
values
...
Insert into Funcionario (Funcionario_ID, Nome, Tipo,Salario, Endereco, genero, data_nascimento,  data_comeco,Desempenho,fk_Armazem_Armazem_ID)
values
